...
public class UniversitySystem {
    public static void main(String[] args) {
        ...
        System.out.println("Accessing name field: " + p.name);

        // Explanation: Upcasting is safe because Student IS-A Person,
        // but we lose access to subclass-specific methods.
    }
}
