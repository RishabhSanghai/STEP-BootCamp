...
public class UseCase3InventorySetup {
    ...
    public static void main(String[] args) {
        ...
        // Initialize domain models for room details
        Room singleRoom = new SingleRoom();
        Room doubleRoom = new DoubleRoom();
        Room suiteRoom = new SuiteRoom();

        // Display Single Room details and centralized availability
        System.out.println("Single Room:");
        singleRoom.displayRoomDetails();
        System.out.println("Available Rooms: " + availabilityMap.get("Single Room") + "\n");

        // Display Double Room details and centralized availability
        System.out.println("Double Room:");
        doubleRoom.displayRoomDetails();
        System.out.println("Available Rooms: " + availabilityMap.get("Double Room") + "\n");

        // Display Suite Room details and centralized availability
        System.out.println("Suite Room:");
        suiteRoom.displayRoomDetails();
        System.out.println("Available Rooms: " + availabilityMap.get("Suite Room"));
    }
}
